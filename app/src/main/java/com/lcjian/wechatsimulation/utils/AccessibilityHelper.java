...
public final class AccessibilityHelper {
     ...
     * 找父组件
     */
    public static AccessibilityNodeInfo findParentNodeInfoByClassName(AccessibilityNodeInfo nodeInfo, String className) {
        if (nodeInfo == null) {
            return null;
        }
        if (TextUtils.isEmpty(className)) {
        ...
        return findParentNodeInfoByClassName(nodeInfo.getParent(), className);
    }
